...
public class Field {
	...
	public void loadImages() {
		whiteImg = new ImageIcon("gui_components/White.png").getImage();
		blackImg = new ImageIcon("gui_components/Black.png").getImage();
		whiteKingImg = new ImageIcon("gui_components/White_King.png").getImage();
		blackKingImg = new ImageIcon("gui_components/Black_King.png").getImage();
	}
